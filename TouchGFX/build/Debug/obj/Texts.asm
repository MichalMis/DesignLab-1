; Listing generated by Microsoft (R) Optimizing Compiler Version 19.33.31630.0 
	...
	TITLE	C:\TouchGFXProjects\Oscyloskop\TouchGFX\build\Debug\obj\Texts.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__5C6E9910_TextProvider@hpp DB 01H
__7BC5CD3F_Texts@hpp DB 01H
__CFFE6067_TypedText@hpp DB 01H
__E0B79B39_MCUInstrumentation@hpp DB 01H
__38B81773_ButtonController@hpp DB 01H
__795C8800_TouchController@hpp DB 01H
__EA027036_Bitmap@hpp DB 01H
__242EAD26_Event@hpp DB 01H
__9FA7FAC2_ClickEvent@hpp DB 01H
__36006C42_DragEvent@hpp DB 01H
__5364BB59_GestureEvent@hpp DB 01H
__4F060EC5_Drawable@hpp DB 01H
__B47F13E6_BlitOp@hpp DB 01H
...
__8ACC936F_Atomic@hpp DB 01H
__2487D505_DMA@hpp DB 01H
__32FBE70C_FrameBufferAllocator@hpp DB 01H
__AA67EC26_UIEventListener@hpp DB 01H
__E818794C_Gestures@hpp DB 01H
__9857B32E_TextureMapTypes@hpp DB 01H
__9FA71CCB_DebugPrinter@hpp DB 01H
__EA7674C5_LCD@hpp DB 01H
__6C75BBBB_HAL@hpp DB 01H
__1E891AE8_TypedTextDatabase@hpp DB 01H
__FA71D18B_Texts@cpp DB 01H
msvcjmc	ENDS
CONST	SEGMENT
...
PUBLIC	??_C@_1MG@IIKFBJNG@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ ; `string'
...
??_C@_1BC@PANDKMKI@?$AAu?$AAs?$AAe?$AAd?$AA?5?$AA?$DO?$AA?5?$AA1@ DB 'u', 00H
	...
	DB	00H, 00H, 00H				; `string'
CONST	ENDS
;	COMDAT ??_C@_1MG@IIKFBJNG@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
CONST	SEGMENT
??_C@_1MG@IIKFBJNG@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ DB 'C'
	DB	00H, ':', 00H, '\', 00H, 'T', 00H, 'o', 00H, 'u', 00H, 'c', 00H
	DB	'h', 00H, 'G', 00H, 'F', 00H, 'X', 00H, 'P', 00H, 'r', 00H, 'o'
	DB	00H, 'j', 00H, 'e', 00H, 'c', 00H, 't', 00H, 's', 00H, '\', 00H
	DB	'O', 00H, 's', 00H, 'c', 00H, 'y', 00H, 'l', 00H, 'o', 00H, 's'
	DB	00H, 'k', 00H, 'o', 00H, 'p', 00H, '\', 00H, 'M', 00H, 'i', 00H
	...
	DB	00H, 'f', 00H, 'x', 00H, '\', 00H, 'T', 00H, 'e', 00H, 'x', 00H
	DB	't', 00H, 'P', 00H, 'r', 00H, 'o', 00H, 'v', 00H, 'i', 00H, 'd'
	DB	00H, 'e', 00H, 'r', 00H, '.', 00H, 'h', 00H, 'p', 00H, 'p', 00H
	DB	00H, 00H					; `string'
CONST	ENDS
...
; File C:\TouchGFXProjects\Oscyloskop\TouchGFX\generated\texts\src\Texts.cpp
; Line 51
	push	ebp
	mov	ebp, esp
	...
	rep stosd
	mov	ecx, OFFSET __FA71D18B_Texts@cpp
...
; File C:\TouchGFXProjects\Oscyloskop\Middlewares\ST\touchgfx\framework\include\touchgfx\TypedText.hpp
; Line 159
	push	ebp
	mov	ebp, esp
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __CFFE6067_TypedText@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 160
...
; _this$ = ecx
; File C:\TouchGFXProjects\Oscyloskop\Middlewares\ST\touchgfx\framework\include\touchgfx\TextProvider.hpp
; Line 268
	push	ebp
	mov	ebp, esp
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __5C6E9910_TextProvider@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 269
	...
	mov	esi, esp
	push	269					; 0000010dH
	push	OFFSET ??_C@_1MG@IIKFBJNG@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@

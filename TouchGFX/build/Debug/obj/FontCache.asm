; Listing generated by Microsoft (R) Optimizing Compiler Version 19.33.31630.0 
	...
	TITLE	C:\TouchGFXProjects\Oscyloskop\TouchGFX\build\Debug\obj\FontCache.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__F283FF45_Utils@hpp DB 01H
__7BC5CD3F_Texts@hpp DB 01H
__CFFE6067_TypedText@hpp DB 01H
__01483C84_FontManager@hpp DB 01H
__A8AB2A25_ApplicationFontProvider@hpp DB 01H
__A1ACC782_FontCache@hpp DB 01H
__D03E5C74_ConstFont@hpp DB 01H
__343A427E_GeneratedFont@hpp DB 01H
__DFDFBC2C_CachedFont@hpp DB 01H
__1E891AE8_TypedTextDatabase@hpp DB 01H
__8F1148D6_FontCache@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	??_C@_1MA@FPHPPLDH@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ ; `string'
...
??_C@_1IE@NPIIMJBA@?$AAt?$AAy?$AAp?$AAe?$AAd?$AAT?$AAe?$AAx?$AAt?$AAs?$AA?5?$AA?$CB?$AA?$DN?$AA?5?$AA0@ DB 't'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1MA@FPHPPLDH@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
CONST	SEGMENT
??_C@_1MA@FPHPPLDH@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ DB 'C'
...
; _this$ = ecx
; File C:\TouchGFXProjects\Oscyloskop\TouchGFX\generated\fonts\include\fonts\CachedFont.hpp
; Line 79
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __DFDFBC2C_CachedFont@hpp
...
; _this$ = ecx
; File C:\TouchGFXProjects\Oscyloskop\TouchGFX\generated\fonts\src\FontCache.cpp
; Line 419
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __8F1148D6_FontCache@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 420
	mov	eax, DWORD PTR _this$[ebp]
...
$LN3@getTextDir:
	mov	esi, esp
	push	144					; 00000090H
	push	OFFSET ??_C@_1MA@FPHPPLDH@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
...
; _this$ = ecx
; File C:\TouchGFXProjects\Oscyloskop\Middlewares\ST\touchgfx\framework\include\touchgfx\Font.hpp
; Line 421
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __F4ECA770_Font@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 422
	xor	eax, eax
; Line 423

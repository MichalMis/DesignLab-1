; Listing generated by Microsoft (R) Optimizing Compiler Version 19.33.31630.0 
	...
	TITLE	C:\TouchGFXProjects\Oscyloskop\TouchGFX\build\Debug\obj\UnmappedDataFont.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__1317380E_FlashDataReader@hpp DB 01H
...
__BC4F1999_UnmappedDataFont@hpp DB 01H
__D83C728E_UnmappedDataFont@cpp DB 01H
msvcjmc	ENDS
...
; _this$ = ecx
; File C:\TouchGFXProjects\Oscyloskop\TouchGFX\generated\fonts\src\UnmappedDataFont.cpp
; Line 70
	push	ebp
	mov	ebp, esp
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __D83C728E_UnmappedDataFont@cpp
...
; _this$ = ecx
; File C:\TouchGFXProjects\Oscyloskop\TouchGFX\generated\fonts\include\fonts\UnmappedDataFont.hpp
; Line 100
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __BC4F1999_UnmappedDataFont@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 101
	mov	eax, DWORD PTR _this$[ebp]
...
; File C:\TouchGFXProjects\Oscyloskop\TouchGFX\generated\fonts\include\fonts\ApplicationFontProvider.hpp
; Line 39
	push	ebp
	mov	ebp, esp
	...
	mov	eax, -858993460				; ccccccccH
	rep stosd
	mov	ecx, OFFSET __A8AB2A25_ApplicationFontProvider@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 40
	xor	eax, eax
; Line 41

...
extern const unsigned char image_blue_check_buttons_check_re_mark_inactive[]; // BITMAP_BLUE_CHECK_BUTTONS_CHECK_RE_MARK_INACTIVE_ID = 3, Size: 44x44 pixels
extern const unsigned char image_button_down_pressed[]; // BITMAP_BUTTON_DOWN_PRESSED_ID = 4, Size: 130x56 pixels
extern const unsigned char image_button_down_released[]; // BITMAP_BUTTON_DOWN_RELEASED_ID = 5, Size: 130x56 pixels
extern const unsigned char image_button_up_pressed[]; // BITMAP_BUTTON_UP_PRESSED_ID = 6, Size: 130x56 pixels
extern const unsigned char image_button_up_released[]; // BITMAP_BUTTON_UP_RELEASED_ID = 7, Size: 130x56 pixels
